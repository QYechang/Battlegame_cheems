...
<div align="center">
  ...
  <br>
  <img src="image/orangecat_base.PNG" alt="Orangecat" width="180" height="180">
  <img src="image/applecat_base.png" alt="Applecat" width="180" height="180">
  <img src="image/bananacat_base.PNG" alt="Bananacat" width="220" height="180">
  <strong>⚔️</strong>
  <img src="image/drog_base.PNG" alt="Drog" width="150" height="150">
  <img src="image/cheems_base.PNG" alt="Cheems" width="160" height="160">
  <img src="image/witchdog_base.PNG" alt="Witchdog" width="210" height="160">
</div>
...
Fire Arrow — deals 20% of the target's current HP
...
Overload — deals 30 direct damage
...
Sonic Bark — deals 20–40 random damage
...
Assault Rifle — deals 1.5× ATK damage
...
Recovery Magic — restores 15 HP and adds 1 ATK
...
Select two heroes on the character-selection screen.

Click Start Battle. Two enemies will be selected randomly.

During each hero's turn, choose one action:
...
After both heroes act, the enemy team takes its turn.

Defeat both enemies before both heroes are defeated.

Click Restart after the battle to choose a new team.

Project Structure

>>>>>>> 2170e95b1ba09367ed7c9ce6121d0edaf75c7f0a
Battlegame_cheems/
